...
async def main():
    ...
    with open('/app/temp_questions.json', 'r') as f:
    ...
    print(f"Current questions for Emergency Medicine: {current_count}")
    ...
    print(f"Total questions for Emergency Medicine now: {new_count}")
