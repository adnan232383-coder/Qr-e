...
COURSE_ID = "NVU_MD_Y4_S2_C35"  # OB/GYN II

async def main():
    # Load questions from JSON file
    with open('/app/obgyn2_batch1.json', 'r') as f:
    ...
    print(f"Current questions in OB/GYN II: {current_count}")
    ...
    if remaining > 0:
        print(f"=== SUCCESS: OB/GYN II now has {new_count}/200 questions ===")
        print(f"=== REMAINING: Need {remaining} more questions to complete ===")
    else:
        print(f"=== ✅ SUCCESS: OB/GYN II (NVU_MD_Y4_S2_C35) is COMPLETE with {new_count}/200 questions! ===")
