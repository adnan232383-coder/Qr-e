...
async def main():
    ...
    with open('/app/pediatrics2_final.json', 'r') as f:
    ...
    # Check completion
    if new_count >= 200:
        print(f"=== ✅ SUCCESS: Pediatrics II (NVU_MD_Y4_S2_C37) is COMPLETE with {new_count}/200 questions! ===")
    else:
        remaining = 200 - new_count
        print(f"=== SUCCESS: Pediatrics II now has {new_count}/200 questions ===")
