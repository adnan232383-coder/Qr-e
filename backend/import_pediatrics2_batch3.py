...
COURSE_ID = "NVU_MD_Y4_S2_C37"  # Pediatrics II

async def main():
    # Load questions from JSON file
    with open('/app/pediatrics2_batch3.json', 'r') as f:
    ...
    print(f"Current questions in Pediatrics II: {current_count}")
    ...
    print(f"=== SUCCESS: Pediatrics II (NVU_MD_Y4_S2_C37) now has {new_count}/200 questions ===")
    
    # Calculate remaining
    remaining = 200 - new_count
    if remaining > 0:
        print(f"=== REMAINING: Need {remaining} more questions to complete this course ===")
    else:
        print(f"=== COMPLETE: Pediatrics II course is fully populated! ===")
