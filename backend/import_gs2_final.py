...
COURSE_ID = "NVU_MD_Y3_S2_C30"  # General Surgery II

async def main():
    # Load questions from JSON file
    with open('/app/surgery2_batch2.json', 'r') as f:
    ...
    print(f"Current questions in General Surgery II: {current_count}")
    ...
    # Check completion
    if new_count >= 200:
        print(f"=== ✅ SUCCESS: General Surgery II (NVU_MD_Y3_S2_C30) is COMPLETE with {new_count}/200 questions! ===")
    else:
        remaining = 200 - new_count
        print(f"=== SUCCESS: General Surgery II now has {new_count}/200 questions ===")
        print(f"=== REMAINING: Need {remaining} more questions ===")
