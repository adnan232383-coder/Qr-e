...
COURSE_ID = "NVU_MD_Y4_S1_C32"  # OB/GYN I

async def main():
    with open('/app/obgyn1_batch2.json', 'r') as f:
    ...
    print(f"Current questions in OB/GYN I: {current_count}")
    ...
    if remaining <= 0:
        print(f"=== ✅ SUCCESS: OB/GYN I is COMPLETE with {new_count}/200 questions! ===")
    else:
        print(f"=== SUCCESS: OB/GYN I now has {new_count}/200 questions ===")
