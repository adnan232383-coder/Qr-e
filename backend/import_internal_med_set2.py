...
COURSE_ID = "NVU_MD_Y3_S1_C24"  # Internal Medicine I

async def main():
    # Load questions from JSON file
    with open("/app/internal_medicine_1_set2.json", "r") as f:
    ...
    print(f"Current questions in Internal Medicine I: {current_count}")
    ...
    print(f"Total questions now: {new_count}")
