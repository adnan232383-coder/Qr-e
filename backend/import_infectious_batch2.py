...
COURSE_ID = "NVU_MD_Y3_S2_C32"  # Infectious Diseases

async def main():
    # Load questions from JSON file
    with open('/app/data/new_questions.json', 'r') as f:
    ...
    print(f"Course: Infectious Diseases (NVU_MD_Y3_S2_C32) now has {new_count}/200 questions")
